...
async function sendTestTweet() {
  console.log('Preparing to send test tweet (Image V2)...');
  ...
  const text = "¿Blockchain te parece complicado? Lo hacemos simple. Empieza tu viaje Web3 hoy, completamente gratis. https://memento-academy.com/es/learn/web3-basics #Web3 (Prueba Manual V2 - Nuevo Diseño)";
